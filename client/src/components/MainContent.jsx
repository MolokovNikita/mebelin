    ...
    return(
            ...
            <div className={styles.first_topic__block}>
                ...
                <div className={styles.topic_block__container}>
                    <div className={styles.first_block__info}>
                        <p><img src="verify.png" alt="" /></p>
                        <h3 style={{fontWeight: 800, fontSize: 20}}><strong>1000+</strong></h3>
                        <p>Клиентов доверяют нашей <br />
                            компании</p>
                        </div>
                    <div className={styles.second_block__info}>
                    <p><img src="arrow.png" alt="" /></p>
                        <p style={{fontWeight: 800, fontSize: 20}}><strong>2460+</strong></p>
        ...
        <div className={styles.second_topic__container}>
            <div className={styles.second_topic_first__block}>
                <h3 className={styles.second_topic_first__text}>Быстрая Доставка Мебели</h3>
                <div className={styles.second_topic_second__container}>
                <p>Быстрая обработка заказов и оперативная доставка товаров клиентам - наши приоритеты!</p>
                <img src="verify.png" alt="verifyImage" />
                </div>
                
            </div>
            <div className={styles.second_topic_second__block}>
            <h3 className={styles.second_topic_second__text}>Гарантия Качества Мебели</h3>
            <div className={styles.second_topic_second__container}>
            ...
            <h3 className={styles.second_topic_third__text}>Качество превыше всего</h3>
            <div className={styles.second_topic_second__container}>
            <p>Высококлассная команда профессионалов гарантирует индивидуальный подход к каждому клиенту!</p>
        ...
        <div className={styles.client_scores__container}>
                ...
                <div className={styles.score_second__item}>
                    <img  className={styles.second_client__avatar} src="woman-ava.png" alt="client1Image" />
                    <div>
                    Екатерина Корнеева
                    <ul className={styles.score_star__list}>
                        <li><img src="star.jpg" alt="" /></li>
                    ...
                    Качество материалов отличное, а цена приятно удивила. Обслуживание также было на высоте - 
                    консультант помог выбрать подходящую модель и ответил на все мои вопросы. Рекомендую!
                    </div>
                </div>
        </div>
                ...
                <div className={styles.faq_item}>
                    ...
                    {faqOpen[0] && (
                        <div className={styles.faq_answer}>
                            Мы всегда стремимся выполнять свою работу быстро и качественно! Обращайтесь - мы готовы помочь вам в любое время!
                        </div>
                    )}
                </div>
                <div className={styles.faq_item}>
                    ...
                    {faqOpen[1] && (
                        <div className={styles.faq_answer}>
Мы всегда стремимся выполнять свою работу быстро и качественно! Обращайтесь - мы готовы помочь вам в любое время!                        </div>
                    )}
                </div>
                <div className={styles.faq_item}>
                    <div
                        ...
                        onClick={() => toggleFaq(2)}
                    >
Какой регион обслуживания у вашей компании? - этот вопрос мы получаем довольно часто от наших клиентов. Мы работаем только в пределах города Москва и Московской области.                        <span>{faqOpen[2] ? '-' : '+'}</span>
                    </div>
                    {faqOpen[2] && (
                        <div className={styles.faq_answer}>
                            Мы обеспечиваем высокое качество 
                            продукции благодаря использованию современных технологий производства и строгому контролю качества на каждом этапе работы. Если клиент остался 
                            недовольным результатом, мы готовы рассмотреть все претензии и предложить решение проблемы.
                        </div>
                    )}
                </div>
            </div>
